...
def _default_io_shapes_fn(module: nn.Module, input: Tuple[torch.Tensor],
...
def _lstm_io_shapes_fn(module: nn.LSTM, input: Tuple[torch.Tensor],
                       output: torch.Tensor) -> Tuple[tuple]:
...
_DEFAULT_IO_SHAPES_FN_MAP = {
    nn.LSTM: _lstm_io_shapes_fn,
    "default": _default_io_shapes_fn
}
